...
1. 如果是跳转别的小程序首页，有appid就可以
2. 如果是跳转公众号文章，需要对方公众号关联你的小程序，公众号有数量限制，同一个主体最多10个，不同主体最多3个
3. 如果是跳转h5，需要配置业务域名，也需要对方的域名服务器放一个你的校验文件
4. 小程序右上角，在默认浏览器打开h5，是没有这个功能的，只有h5有这个功能

...
### 宝塔设置 A 站点 SSL,同服务器下其他未设 SSL 站点访问 HTTPS 默认会打开 A 站点
...
开发人员可以使用 LAMP 堆栈来创建、托管和维护 Web 内容。它是一种流行解决方案，可为您当今常用的许多网站提供支持。

1. L: 代表服务器操作系统Linux

2. A：代表网站服务Apache

   提供web服务，接受用户连接请求，支持静态页面解析

   当客户端请求的是静态资源时，web服务会直接返回静态资源给客户端

3. M：代表网站后台使用的MySql数据库

   存储数据

4. P：代表网站使用PHP开发语言

   负责php脚本程序的解析，实现与数据库MySql交互工作
